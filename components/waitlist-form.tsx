  ...
  const steps: Step[] = [
    {
      ...
      description: "Link your Discord account to join our CodeClaim community",
      icon: Discord,
      isRequired: true,
    },
    {
      ...
      description: "Link your Telegram for CodeClaim updates",
      icon: MessageSquare,
      isRequired: true,
    },
    {
      ...
      description: "Link your X/Twitter account to spread the word about CodeClaim",
      icon: Twitter,
      isRequired: true,
    },
    {
